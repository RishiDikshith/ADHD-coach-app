...
class MicroTaskGenerator:
            ...
            personalized.append(
                {
                    "step": step,
                    "estimated_minutes": 2
                    if "2-minute" in step or "2 min" in step.lower()
                    else 5
                    if "5-minute" in step
                    else 10
                    if "10-minute" in step
                    else 5,
                    "category": category,
                }
            )
    ...
    def generate_breakthrough_sequence(self, task: str, paralysis_level: str) -> list:
        ...
        if paralysis_level == "severe":
            ...
            return [
                {
                    "step": "Take 3 deep breaths first. You're safe.",
                    "estimated_minutes": 1,
                    "category": "grounding",
                },
                {
                    "step": f"Look at your task '{task}' for 10 seconds. That's it.",
                    "estimated_minutes": 1,
                    "category": "exposure",
                },
                {
                    "step": "Name ONE feeling about this task without judgment.",
                    "estimated_minutes": 1,
                    "category": "reflection",
                },
                {
                    "step": "Tell yourself: 'I can stop after one tiny step.'",
                    "estimated_minutes": 1,
                    "category": "permission",
                },
                {
                    "step": base_steps[0]["step"]
                    if base_steps
                    else self.get_two_minute_starter(task),
                    "estimated_minutes": 2,
                    "category": "action",
                },
            ]
            ...
            return [
                {
                    "step": "Set a 5-minute 'just start' timer",
                    "estimated_minutes": 1,
                    "category": "preparation",
                },
                {
                    "step": self.get_two_minute_starter(task),
                    "estimated_minutes": 2,
                    "category": "action",
                },
                {
                    "step": "Check in: how do you feel after starting?",
                    "estimated_minutes": 1,
                    "category": "reflection",
                },
            ] + base_steps[:2]
