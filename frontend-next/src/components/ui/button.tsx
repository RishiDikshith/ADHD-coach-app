...
const variants: Record<Variant, string> = {
  ...
  secondary: "bg-surface text-foreground border border-border hover:bg-border/50 active:bg-border",
  ghost: "text-muted hover:text-foreground hover:bg-white/5 active:bg-white/10",
  danger: "bg-danger-500 text-white hover:bg-danger-400 active:bg-danger-600",
  calm: "bg-calm-900/30 text-calm-300 border border-calm-700/50 hover:bg-calm-800/40 hover:border-calm-500/50",
  outline:
    "border border-border-light text-foreground hover:bg-surface hover:border-calm-500/50 active:bg-white/5",
  glass: "glass text-foreground hover:bg-white/10 active:bg-white/15",
};
